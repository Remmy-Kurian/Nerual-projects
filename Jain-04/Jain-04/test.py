...
def test_train():
    ...
    model = Sequential()  
    model.add(Conv2D(40, (1, 1), padding='same', activation='sigmoid'))
    model.add(MaxPooling2D(pool_size=(2, 2)))
    model.add(Conv2D(20, (2, 2), padding='same', activation='sigmoid'))
    model.add(Flatten())
...
def test_evaluate():
    ...
    model.add(Conv2D(46, (1, 1), padding='same', activation='sigmoid'))
    model.add(MaxPooling2D(pool_size=(2, 2)))
    model.add(Conv2D(18, (3, 3), padding='same', activation='sigmoid'))
    model.add(Flatten())
